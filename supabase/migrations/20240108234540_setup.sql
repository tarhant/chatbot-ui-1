...
AS $$
DECLARE
  project_url TEXT := 'https://nolshgczncixsxzwvhlt.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5vbHNoZ2N6bmNpeHN4end2aGx0Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMDQwMzAyMywiZXhwIjoyMDI1OTc5MDIzfQ.VsAAUnHoQQKsOLptnZw40nbx746VUBkSwUclt9B-f7s'; -- full access needed for http request to storage
